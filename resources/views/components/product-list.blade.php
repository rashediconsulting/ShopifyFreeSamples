<div class="p-5 ml-[400px] mt-3  w-full">
  ...
  <div class=" items-center bg-white rounded mt-3 flex justify-around gap-10 p-5 mb-5 shadow">
    <div class="flex gap-3">
      ...
      <input type="text" wire:model="name" wire:change="saveChanges()" name="name" id="name" class="w-[150px]">
    </div>
    <div class="flex gap-3 group">
      <label class="text-[#6C1131] font-bold" for="active">Active</label>
      <input type="checkbox" wire:model="active" wire:change="saveChanges()" name="active" id="active" value="active">
    ...
    <div class="flex gap-3 group">
      ...
      <input type="number" wire:model="quantity" wire:change="saveChanges()" name="quantity" id="quantity" class="w-[40px]">
    ...
    <div class="flex gap-3 group">
      ...
      <input type="checkbox" wire:model="display_in_checkout" wire:change="saveChanges()" name="display_in_checkout" id="display_in_checkout" value="display_in_checkout">
    ...
    <div class="flex gap-3 group">
      ...
      <input type="checkbox" wire:model="repeatable" wire:change="saveChanges()" name="repeatable" id="repeatable" value="repeatable">
